...
|-----------|-------|----------|--------|-------|---------------|
| **Forge** | Yes | 1.20.1 only | No | No | No |
| **NeoForge** | 1.20.1 only | Yes | via Connector | No | No |
| **Fabric** | No | via Connector | Yes | mostly | No |
| **Quilt** | No | No | No | Yes | No |
| **Legacy Fabric** | No | No | No | No | Yes |
